...
=== Ecosystem of Generative AI Tools
image::GenAIEcosystem.jpg[ddd][Generative AI Ecosystem]

source: https://linkedin.com/in/tinaw-h
...
image::ComponentsOfAPrompt.jpg[Components of a Prompt]
==== Role
You are an AI research assistant focused on identifying and summarizing recent trends in AI
...
=== Prompt to Write Naturally
Prompt that makes ChatGPT write naturally
...
** Simplify grammar: Don't stress about perfect grammar; it's fine not to capitalize "j" if that's your style.
